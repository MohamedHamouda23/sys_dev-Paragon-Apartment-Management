...
class ApartmentManagerPage:
        ...
        if not apartments:
            ...
            for apt in apartments:
                ...
                tk.Label(
                    ...
                    anchor="w", bg="white", font=("Arial", 12)
    ...
    def show_add_building_stepper(self):
        ...
        street_entry = tk.Entry(self.box_frame, width=40)
        street_entry.pack()

        tk.Label(self.box_frame, text="Postcode:").pack()
        postcode_entry = tk.Entry(self.box_frame, width=20)
        postcode_entry.pack()
...
class AddApartmentStepper:
    ...
    def step_city(self):
        ...
        city_dropdown.pack()
        tk.Button(self.box_frame, text="Next",
    ...
    def step_address(self, selected_city):
        ...
        if not addresses:
            tk.Label(self.box_frame, text="No buildings available in this city.", fg="red").pack(pady=10)
    ...
    def step_details(self, selected_city, selected_address):
        ...
        tk.Button(
            self.box_frame, text="Add Apartment",
